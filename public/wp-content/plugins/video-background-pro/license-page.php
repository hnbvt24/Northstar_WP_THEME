...
if ( ! class_exists( 'PL_VBP_License' ) ) {
  class PL_VBP_License {
    ...
    public $ame_menu_tab_getting_started_title;
    public $ame_options;
    ...
    public function __construct( $file, $software_title, $software_version, $plugin_or_theme, $api_url, $text_domain, $extra ) {
      ...
      if ( is_admin() ) {
        ...
        $this->ame_getting_started             = $this->data_prefix . '_getting_started';
        ...
        $this->ame_menu_tab_getting_started_title = __( 'Getting Started', 'video-background-pro' );
    ...
    public function config_page() {
      $settings_tabs = array(
        ...
        $this->ame_getting_started => __( $this->ame_menu_tab_getting_started_title, 'video-background-pro' ),
      );
      ...
      ?>
          ...
          ?>
            ...
            if ( $tab == $this->ame_activation_tab_key ) {
            ...
            } elseif ( $tab == $this->ame_deactivation_tab_key ) {
              ...
              submit_button( __( 'Save Changes', $this->text_domain ) );
                ...
                echo '<ol>';
                  _e( '<li><a href="https://pushlabs.co/docs/video-background-pro/#using-the-metabox" target="_blank">Using the metabox</a></li>', 'video-background-pro' );
                  _e( '<li><a href="https://pushlabs.co/docs/video-background-pro/#using-visual-composer" target="_blank">Using the WPBakery (Visual Composer) integration</a></li>', 'video-background-pro' );
                  _e( '<li><a href="https://pushlabs.co/docs/video-background-pro/#using-page-builder" target="_blank">Using the SiteOrigin Page Builder Integration</a></li>', 'video-background-pro' );
                  _e( '<li><a href="https://pushlabs.co/docs/video-background-pro/#using-the-shortcode" target="_blank">Using the shortcode.</a></li>', 'video-background-pro' );
                echo '</ol>';
                _e( '<p>For full documentation, instructions, and video tutorials, please visit <a href="https://pushlabs.co/docs/video-background-pro" target="_blank">the docs</a>.</p>', 'video-background-pro' );
                _e( '<p>If you couldn\'t find a solution in the docs, please <a href="https://pushlabs.co/support" target="_blank">open a ticket.</a></p>', 'video-background-pro' );
                _e( '<p>If you\'ve lost you license key, you can <a href="https://pushlabs.co/lost-license/" target="_blank">recover it here.</a></p>', 'video-background-pro' );
            }
            ?>
                    </div>
                </form>
