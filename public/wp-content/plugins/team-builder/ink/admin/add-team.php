...
<div style=" overflow: hidden;padding: 20px;margin-bottom:30px;">
    ...
    right: 0;"><a style="color:#fff;text-decoration:none" target="_new" href="http://demo.wpshopmart.com/team-pro-demo/slider-list/">Demo</a></span>
				...
				<div style="padding:13px;overflow:hidden; background: #EFEFEF; border-top: 1px dashed #ccc;">
					...
					<a  class="pull-right btn btn-primary design_btn" href="https://wpshopmart.com/plugins/team-pro/" target="_blank" style="    background-color: #e0bf1b;    border-color: #e0bf1b;">Get In Pro</a>
				</div>		
			</div>
