...
class wpsm_team_b {
	...
	public function wpsm_team_b_meta_boxes_group(){
		...
		add_meta_box('team_b_support', __('Need Help', wpshopmart_team_b_text_domain), array(&$this, 'wpsm_team_b_help_function'), 'team_builder', 'side', 'low');		
	...
	public function wpsm_team_b_help_function(){
	?>
		<style>
		#team_b_support{
			background:#e6c20f;
			...
			#team_b_support .hndle , #team_b_support .handlediv{
			display:none;
			}
			#team_b_support h1{
			color:#fff;
		   ...
		   <h1>NEED HELP, Get Support!</h1>
			<a href="https://wordpress.org/support/plugin/team-builder/" target="_blank" class="button button-primary button-hero ">Open your support ticket</a>
	...
	public function wpsm_team_b_rateus_meta_box_function(){
		...
		#team_b_rateus{
		   ...
		   <h1>Rate This Plugin </h1>
			<a href="https://wordpress.org/support/plugin/team-builder/reviews/?filter=5" target="_blank" class="button button-primary button-hero ">Rate  Here</a>
			<a class="wpsm-rate-us" style=" text-decoration: none; height: 40px; width: 40px;" href="https://wordpress.org/support/plugin/team-builder/reviews/?filter=5" target="_blank">
