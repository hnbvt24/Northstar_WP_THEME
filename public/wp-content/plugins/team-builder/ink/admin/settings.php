	...
	<tbody>
		...
		<tr >
			...
			<td>
				...
				<div style="margin-top:10px;display:block;overflow:hidden;width:100%;"> <a style="margin-top:10px" href="https://wpshopmart.com/plugins/team-pro/" target="_balnk">Get 500+ Google Fonts In Premium Version</a> </div>
		...
		<tr>
			...
			<td>
				...
				<div style="margin-top:10px;display:block;overflow:hidden;width:100%;"> <a style="margin-top:10px" href="https://wpshopmart.com/plugins/team-pro/" target="_balnk">Get More 6+ More Column Layout In Premium Version</a> </div>
		...
		<tr>
			...
			<td>
				...
				<div style="margin-top:10px;display:block;overflow:hidden;width:100%;"> <a style="margin-top:10px" href="https://wpshopmart.com/plugins/team-pro/" target="_balnk">Unlock More Settings and feature in Premium Version</a> </div>
