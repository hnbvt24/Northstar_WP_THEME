			<?php
				...
				$firstHeader 	= get_post_meta( 30, 'First_Section_Header', true );
				$secondHeader	= get_post_meta( 30, 'Second_Section_Header', true );
				$thirdHeader	= get_post_meta( 30, 'Third_Section_Header', true );
    			$fourthHeader	= get_post_meta( 30, 'Fourth_Section_Header', true );
				$firstText 		= get_post_meta( 30, 'First_Section_Text', true );
				$secondText 	= get_post_meta( 30, 'Second_Section_Text', true );
				$thirdText 		= get_post_meta( 30, 'Third_Section_Text', true );
				$fourthText 	= get_post_meta( 30, 'Fourth_Section_Text', true );
				$staffImg1		= get_post_meta( 30, 'staff_member_1', true );
				$staffImg2		= get_post_meta( 30, 'staff_member_2', true );
				$newsBtn		= get_post_meta( 30, 'news_btn', true );
				$newsLink		= get_post_meta( 30, 'news_link', true );
				$registerBtn	= get_post_meta( 30, 'register_btn', true );
				$registerLink	= get_post_meta( 30, 'register_link', true );
				$fbLink			= get_post_meta( 30, 'fb_link', true);
				$instaLink		= get_post_meta( 30, 'insta_link', true);
			?>
